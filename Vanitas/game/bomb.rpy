...
label sawallthreekloth:
    ...
    "Atropos" "Kloth in letzter Zeit?"

    "Atropos" "Wolltest du das sagen?"
    ...
    "Chesis" "Was willst du herausgefunden haben? Wie glücklich alle Menschen sind?"
    ...
    "Atropos" "Aber sie sind nicht wirklich glücklich! Das ist alles nur erzwungenes Glück!"
    ...
    "Atropos" "Er hat mir ja gar nicht zugehört… das ist auch Aithers Schuld… ich muss… ich muss…"

    "Atropos" "Ich muss etwas dagegen unternehmen!"
    ...
    "Atropos" "Der Serverraum? Kann es sein, dass dort die Bombe liegt?"

    "Atropos" "Wie viel Zeit wohl noch bleibt? Auf wann hat Kloth die Bombe gesetzt?"

    "Atropos" "Wann wird sie explodieren?"

    "Atropos" "Wenn die Bombe explodiert… kann Aither damit vielleicht ein Ende bereitet werden?"
    ...
    "Atropos" "Wenn ich erst nach der Bombe schaue, könnte es zu spät für sie sein."

    "Atropos" "Aber was, wenn die Bombe gar nicht erst im Serverraum existiert? Immerhin habe ich zwar Hinweise darauf, weiß aber nicht, ob sie tatsächlich dort ist."
...
label savepeoplesawallthreekloth:
    ...
    "Atropos" "Was soll ich tun?"

    "Atropos" "Der Feuermelder… ich könnte versuchen ihn zu aktivieren, aber würden die Leute darauf hören?"
...
label savefriendsallthreekloth:
    ...
    "Atropos" "Wenn hier wirkliche eine Bombe ist, ist es mir um die Firma herzlich egal… aber ich muss versuchen, meine Freunde rauszuhalten."

    "Atropos" "Ich kann sie bestimmt überzeugen, heute frühzeitig nach Hause zu gehen und dann kann ich nach der Bombe sehen."

    "Atropos" "Aber nach wem soll ich als Erstes suchen? Ich weiß nicht wie viel Zeit mir noch bleibt. Es könnten Tage sein, aber vielleicht auch nur Minuten…"

    "Atropos" "Ich… verdammt…"
...
label saveeralab:
    ...
    "Era" "Atropos? Wie… wie schön dich zu sehen… w-willst du gemeinsam in die Mittagspause?"
    ...
    "Atropos" "Wenn es um dich geht… bin ich wohl etwas aufmerksamer als bei anderen…"
...
label saveeraelsewhere:
    ...
    "Atropos" "Du musst gehen. Verlasse Aither! Sofort!"

    "Era" "W-Warum? Was… was ist los?"
...
label savechesis:
    ...
    "Chesis" "Also- was ist los?"

    "Atropos" "Wegen vorher…"

    "Chesis" "Vorher? Was meinst du?"

    if talkchesismorning:

        "Chesis" "Du meinst das Gespräch im Flur heute Morgen?"
    ...
    "Chesis" "Ich rede immer gerne mit dir, aber meine Kundin wartet…"
    ...
    "Atropos" "Er… er ist heute nicht in der Arbeit. Er ist gestern gestürzt. Ich hatte vorher bei ihm angerufen und er hat es mir erzählt."

    "Atropos" "Kannst du nach ihm sehen?"
...
label savetycho:
    ...
    "Atropos" "Gehen wir ins Büro, dort sind wir ungestört."
    ...
    "Atropos" "Alle hier sind in Gefahr!"

    "Tycho" "Ach ja, und welche Art von Gefahr sollte das sein?"
    ...
    "Atropos" "Nein! Warte doch… bitte…"

    "Atropos" "Könnt ihr den Rest der Mittagspause nicht außerhalb von Aither verbringen? Bitte…"

    "Tycho" "Ich muss mit den anderen sprechen… vielleicht, okay? Ich kann dir nichts versprechen…"
...
label savekloth:
    ...
    "Atropos" "Hast du Kloth gestern nach Hause gehen sehen? Oder heute Morgen kommen sehen?"

    "Zelos" "Keins von beiden und normalerweise kommt er immer durch den Laden hindurch. Andererseits…"
...
label saveallallthreekloth:
    ...
    "Tycho" "Du machst zu viel Aufstand um nichts. Möchtest du den Rest der Mittagspause noch mit uns verbringen? Wir wollten uns gerade einen Kaffee holen."
    ...
    "Anan" "Ich hatte zuvor im Büro nicht den Eindruck, dass du etwas zu verbergen hast, aber jetzt habe ich diesen Eindruck."

    "Anan" "Was hat sich also geändert?"
    ...
    "Atropos" "Aber wessen Schuld ist das wohl? Allein deine! Du zwingst die Menschen zu diesem falschen Glück!"
    ...
    "Anan" "Willst du die Menschen retten? Oder willst du einfach nur abwarten und sie sterben lassen?"

    "Atropos" "Ich weiß es nicht. Ich habe keine Ahnung, wann die Bombe hochgeht."

    "Anan" "Stoppe die Bombe. Denk an das Glück all dieser Menschen."
    ...
    "Durchsage" "Ich muss euch bitten, augenblicklich Aither zu verlassen. Nur so kann ich euer Glück weiterhin gewährleisten."

    "Durchsage" "Egal, was ihr gerade auch tun mögt. Legt eure Arbeit nieder und verlasst das Gebäude."

    "Durchsage" "Vertraut mir und vertraut meinen Worten, so wie ihr es immer getan habt."

    "Durchsage" "Verlasst Aither und vergesst diesen Tag. Für immer."

    "Durchsage" "Seid glücklich. Ich danke euch, dass ihr mir dabei geholfen habt, der Menschheit ihr Glück zu bringen."
    ...
    "Anan" "Ohne Aither wird die Welt im Chaos versinken. Ich hoffe, das ist dir bewusst und du bist bereit die Verantwortung für deine Entscheidungen zu tragen."
    ...
    "Anan" "Weil Happiness nur dann wirken kann, wenn alle sie nehmen. Sadness ist ansteckend."

    "Atropos" "Werden wir sterben?"

    "Anan" "Hast du Angst vor dem Tod?"
...
label doesbombexistsawallthreekloth:
    ...
    "Atropos" "Was ist, wenn ich unnötig Panik schiebe?"
    ...
    "Atropos" "Ich werde nicht länger blind vor Glück sein. Meine Augen sind offen und ich weiß, dass ich das Richtige tue!"

    "Atropos" "Die Menschheit wird mir dafür danken. Ich werde ihnen wahre Glücklichkeit bringen- ohne die Zwänge von Aither."

    "Atropos" "Ohne dieses aufgezwungene Glück!"

    "Atropos" "Ohne dieses verdammte Glück…"

    "Atropos" "Ohne falsches Glück…"

    "Atropos" "Ich… ich tue das Richtige!"

    "Atropos" "Ja, ganz bestimmt!"

    "Atropos" "Und es ist ja nicht meine Schuld… ich habe die Bombe nicht gelegt… es ist nicht meine Schuld…"
    ...
    "Atropos" "Was… Was soll ich nur tun?"

    "Atropos" "Bisher war mein Leben immer so einfach gewesen. Ich wusste genau, was ich tun musste. Ich war einfach… glücklich."

    "Atropos" "Warum ist es jetzt so schwer glücklich zu sein? Warum… Warum kann ich es nicht einfach sein?"

    "Atropos" "Es kann doch nicht möglich sein, dass ich unbedingt Happiness dazu brauche…"
    ...
    "Atropos" "Und was ist mit mir? Ich werde sterben, oder?"

    "Atropos" "Kann ich es in der Zeit schaffen, das Gebäude zu verlassen?"

    "Atropos" "Ich… ich bin wie erstarrt…"

    "Atropos" "Was passiert hier?"

    "Atropos" "Ist gleich wirklich alles vorbei?"

    "Atropos" "Ich hoffe nur, ich habe das Richtige getan…"

    "Atropos" "Ich hoffe, ich habe der Menschheit damit einen Gefallen getan…"

    "Atropos" "Aber all die Hinweise… es muss so sein…"
...
label nextstepwithbomb:
    ...
    "Atropos" "Und was ist mit Anan? Ich kann ich nach all meinem Wissen doch nicht ungeschoren davonkommen lassen!"

    "Atropos" "So würde er Aither am Ende nur wieder neu aufbauen. Soll ich sichergehen, dass er das hier nicht überlebt?"
...
label trywarnpeople:
    ...
    "Atropos" "Es spielt keine Rolle… ich muss es versuchen!"
    ...
    "Atropos" "Da… das rote Leuchten… Das muss sie sein…"
    ...
    "Atropos" "Ja… ich denke schon…"

    "Atropos" "Dann können sie endlich wirklich glücklich sein und müssen nicht mehr nur noch mit diesem aufgezwungenen Glück leben!"

    "Atropos" "Wie die Menschen wohl in ein paar Jahren leben werden? Werden sie mir dankbar sein für das, was ich getan habe? Für das, was – vermutlich – Kloth getan hat? Oder werden sie uns hassen?"

    "Atropos" "Glück durch Happiness ist die einfachere Lösung, aber ist es das wirklich wert, wenn man dafür seinen freien Willen verliert?"
    ...
    "Atropos" "Auch unsere Vorfahren hatten sie nicht gebraucht. Wir haben genug Nahrungsmittel und Wasser für alle."

    "Atropos" "Es wird zu keiner Wiederholung des 50-jährigen Krieges kommen, egal was die Großen Drei auch behaupten mögen."

    "Atropos" "Sie wollen doch nur an der Macht bleiben und haben Angst ihre Bedeutung zu verlieren…"

    "Atropos" "Niemand kann so lange die Macht behalten und sich dieser nicht ergeben. Ihnen ist schon lange nicht mehr das Glück der Menschen wichtig, so sehr sie das auch uns und sich selbst einzureden versuchen."

    "Atropos" "Ich tue das Richtige! Ja, ganz bestimmt!"
...
label doesbombexist:
    ...
    "Atropos" "Was, wenn ich doch Schuld trage?"
    ...
    "Atropos" "Bisher war mein Leben immer so einfach. Ich wusste genau, was ich tun musste. Ich war einfach… glücklich."
...
label besureanandies:
    ...
    "Atropos" "Ich kann einfach nicht zulassen, dass er überlebt. Nein, das kann ich wirklich nicht!"

    "Atropos" "Aber schaffe ich es wirklich, einen Menschen zu töten?"

    "Atropos" "Aktiv?"

    "Atropos" "Das ist etwas vollkommen anderes, als eine Bombe einfach nur hochgehen zu lassen…"

    "Atropos" "Was soll ich nur tun?"

    "Atropos" "Ich muss es wenigstens versuchen, oder?"

    "Atropos" "Das bin ich der Menschheit schuldig."

    "Atropos" "Ich kann nicht zulassen, dass Anan ein neues Aither errichtet."

    "Atropos" "Dass sich am Ende alles genau gleich wiederholt…"

    "Atropos" "Das darf einfach nicht passieren!"

    "Atropos" "Aber wie kann ich sichergehen, dass Anan wirklich von der Bombe erwischt wird? Was, wenn sie nur den Serverraum in die Luft reißt, aber nicht das ganze Gebäude?"

    "Atropos" "Was ist, wenn Anan in dem Moment gar nicht in Aither ist, in dem die Bombe hochgeht?"
    ...
    "Atropos" "Immerhin weiß er nicht, wie viel ich weiß."
    ...
    "Anan" "Alles? Ich denke, du musst dich etwas deutlicher ausdrücken."
    ...
    "Atropos" "Du kennst also die ultimative Wahrheit? Nun, ich bin mir aber sicher, dass auch du nicht alles weißt."
    ...
    "Anan" "Und das alles ohne ein System, welches diese Emotionen unter Kontrolle hält. Es gibt keine andere Lösung."
...
label ananorjustbombwho:
    ...
    if murderer:
        ...
        "Chesis" "Oh hey! Ich bin noch in einem Gespräch, danach können wir gerne Mittagspause machen."
        ...
        "Atropos" "Warum?! Warum möchtest du zurück?"
        ...
        "Atropos" "Nein, habe ich nicht und das hat mir endlich die Augen geöffnet!"

        "Atropos" "Siehst du das?"

        "Atropos" "Siehst du das hier?"

        "Atropos" "Kloth ist tot und du hast ihn ermordet!"
        ...
        "Atropos" "Was verdammt noch mal redest du da gerade bitte?"

        "Atropos" "Was sollen diese jämmerlichen Ausreden?"
        ...
        "Atropos" "Nicht du bist das Problem…"

        "Atropos"  "Happiness… Happiness muss schuld sein!"

        "Atropos"  "Verdammt… wie konnte ich das gerade so sehr verdrängen?"

        "Atropos"  "Aus einem anderen Grund ist es einfach nicht möglich, dass du Kloth töten würdest."
        ...
        "Atropos"  "Bin ich schuld an Kloths Tods? Oder ist es Chesis?"

        "Atropos"  "Nein, diese Frage sollte ich mir nicht stellen! Keiner von uns beiden ist schuld!"

        "Atropos"  "Es muss an Happiness liegen! Nur Aither ist schuld!"

        "Atropos"  "Die Pille ist dafür verantwortlich, dass das passiert ist und gleichzeitig, dass ich es auch wieder vergessen habe!"

        "Atropos"  "Diese verdammte Happiness! Ich will sie nicht! Ich will sie nicht nehmen… sie hat Kloth getötet… Anan hat Kloth getötet!"

        "Atropos"  "Aber sie werden alle dafür büßen. Kloth, dein Tod wird nicht ungerächt bleiben! Dafür sorge ich!"
...
label after_detail_blog3:
    ...
    "Atropos"  "Musste er dafür etwa sein Leben lassen?"
...
label ananshoulddie:
    ...
    "Atropos"  "Ich muss dafür sorgen, dass er in den Serverraum geht, kurz bevor die Bombe explodiert."

    "Atropos"  "Aber wo ist er jetzt? Und wie bringe ich ihn dazu?"
    ...
    "Atropos"  "Weil du uns zu diesem Glück zwingst! Es war keine Lüge, dass Kloth tot ist! Er musste wegen Happiness sterben… deinetwegen!"

    "Anan"  "Es ist möglich, dass er der Verantwortung seiner Position nicht gewachsen war. Dennoch war es seine eigene freiwillige Entscheidung."

    "Atropos"  "Position? Er war doch nur dein verdammter Sekretär!"
...
label aithershoulddie:
    ...
    "Atropos"  "Auf dass die Menschen ohne dich glücklicher sein mögen!"

    "Atropos"  "Kloth… Kloth… warum nur? Ich wünschte, du wärst jetzt an meiner Seite…"

    "Atropos"  "Das hier wolltest du doch, oder?"
